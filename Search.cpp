...
std::set<std::string> Search::getUniqueWords(const std::string& request)
{
...
std::vector<std::pair<std::string, size_t>> Search::getWordsEntries(const std::set<std::string>& words)
{
...
std::vector<size_t> Search::getAllDocumentsWithWords(const std::vector<std::pair<std::string, size_t>> &words)
{
...
void Search::sortWordsAscendingToEntries(std::vector<std::pair<std::string, size_t>>& wordsEntries)
{
...
size_t Search::getAbsoluteRelevanceForDocument(size_t docId, std::set<std::string> &uniqueWords) {
...
std::vector<std::vector<RelativeIndex>> Search::search(const std::vector<std::string>& queries_input)
{
...
void Search::setMaxResponses(const int &newMaxResponses)
{
